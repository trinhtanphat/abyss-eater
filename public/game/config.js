export const QUALITY_PROFILES = Object.freeze({
  ...
  balanced: Object.freeze({ dpr: 1.5, bubbles: 170, plankton: 260, rocks: 18, kelp: 22, coral: 14, shafts: 5, effectParticles: 24 }),
...
export function resolveQuality(requested = 'auto') {
  ...
  if (coarse || narrow) return 'balanced';
  if (highDpr) return 'balanced';
  return 'high';
}
