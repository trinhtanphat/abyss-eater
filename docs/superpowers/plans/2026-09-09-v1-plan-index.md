...
Implementation follows the approved V1 Full A+B+C design and keeps each carrier independently testable.

- Carrier 1: DONE — protocol, rate limits, deterministic collisions, reconnect and room lifecycle.
- Carrier 2: DONE — MVP polish, accessibility, settings, PWA, audio and premium presentation.
- Carrier 3: DONE — opaque guest sessions, D1 progression, pearls, skins/shop and durable seasonal/all-time leaderboards.
